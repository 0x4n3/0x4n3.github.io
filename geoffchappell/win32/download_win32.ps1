$outputdir = 'D:\Geoff Chappell\win32'
$url       = 'https://www.geoffchappell.com/studies/windows/win32/toc.htm'
...
$WebResponse.Links | Select-Object -ExpandProperty href -Skip 1 | ForEach-Object {
    ...
    $fileUrl  = 'https://www.geoffchappell.com/studies/windows/win32/{1}' -f $url.TrimEnd('/'), $_
