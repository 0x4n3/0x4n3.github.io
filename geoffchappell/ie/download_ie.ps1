$outputdir = 'D:\Geoff Chappell\ie'
$url       = 'https://www.geoffchappell.com/studies/windows/ie/toc.htm'
...
$WebResponse.Links | Select-Object -ExpandProperty href -Skip 1 | ForEach-Object {
    ...
    $fileUrl  = 'https://www.geoffchappell.com/studies/windows/ie/{1}' -f $url.TrimEnd('/'), $_
