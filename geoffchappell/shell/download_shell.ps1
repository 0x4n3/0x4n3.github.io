$outputdir = 'D:\Geoff Chappell\shell'
$url       = 'https://www.geoffchappell.com/studies/windows/shell/toc.htm'
...
$WebResponse.Links | Select-Object -ExpandProperty href -Skip 1 | ForEach-Object {
    ...
    $fileUrl  = 'https://www.geoffchappell.com/studies/windows/shell/{1}' -f $url.TrimEnd('/'), $_
