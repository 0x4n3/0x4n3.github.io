$outputdir = 'D:\Geoff Chappell\kernel'
$url       = 'https://www.geoffchappell.com/studies/windows/km/toc.htm'
...
$WebResponse.Links | Select-Object -ExpandProperty href -Skip 1 | ForEach-Object {
    ...
    $fileUrl  = 'https://www.geoffchappell.com/studies/windows/km/{1}' -f $url.TrimEnd('/'), $_
